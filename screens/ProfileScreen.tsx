  ...
  return (
    <div className="flex flex-col gap-8 animate-fadeIn pb-32">
      ...
      <section className="flex flex-col items-center pt-4">
        ...
        <p className="text-slate-400 font-medium text-sm">Academic Elite</p>
      </section>
        ...
        <div className="flex flex-col gap-4">
          <div className="flex justify-between items-end">
             <div>
               ...
               <p className="text-[10px] text-slate-500 font-bold uppercase mt-1">Goal: {XP_PER_TIER} RP to Tier Break</p>
             </div>
          ...
          <div className="w-full h-4 bg-slate-800/50 rounded-full overflow-hidden border border-white/5 relative">
            ...
            />
            {/* Metal Shine overlay */}
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent pointer-events-none skew-x-[-20deg]" />
          </div>
        </div>
      </section>
      ...
      <section className="grid grid-cols-2 gap-4">
        <div className="glass-card p-5 rounded-3xl relative overflow-hidden group">
          <div className="absolute top-[-10px] right-[-10px] text-4xl opacity-5 group-hover:scale-125 transition-transform duration-500">🔥</div>
          <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest mb-1">Consistency Streak</p>
          <div className="flex items-center gap-2">
            <span className="text-2xl font-black text-orange-500">{user.streak} Days</span>
          </div>
        </div>
        <div className="glass-card p-5 rounded-3xl relative overflow-hidden group">
           <div className="absolute top-[-10px] right-[-10px] text-4xl opacity-5 group-hover:scale-125 transition-transform duration-500">⚔️</div>
          <p className="text-[9px] font-bold text-slate-500 uppercase tracking-widest mb-1">Total Victories</p>
          <div className="flex items-center gap-2">
